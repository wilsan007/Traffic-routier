// Icônes SVG inline (traits, 20px) — pas de dépendance externe
interface IconProps {
  className?: string;
}
...
export function IconCar({ className }: IconProps) {
  return (
    <svg className={`${base} ${className ?? ''}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18 10.5l-1.9-3.8A2 2 0 0 0 14.3 5H9.7a2 2 0 0 0-1.8 1.1L6 10l-2.5.6C2.7 10.8 2 11.6 2 12.5V16c0 .6.4 1 1 1h2" />
