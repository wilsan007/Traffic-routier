    ...
    <div className="min-h-screen bg-slate-100">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-6 py-5">
          ...
          <div>
            <h1 className="text-lg font-bold text-brand-900">Portail citoyen — Contraventions</h1>
        ...
        {pv && (
          <div className="card animate-in space-y-5">
            <div className="flex items-start justify-between">
              ...
              <span className="badge bg-slate-100 text-slate-700">{STATUS_FR[pv.status] ?? pv.status}</span>
            </div>
